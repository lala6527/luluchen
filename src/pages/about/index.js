    ...
    return(
        ...
        <div className="container">
            ...
            <figure className="flex pb-12">
                <img src="./images/workimage.png" alt="workimage" className="w-20 h-20 p-2 inline-block border border-black/10 rounded-lg bg-white" />
            <div className="pl-4">
            ...
            <figure className="flex pb-12">
            <img src="./images/vino.jpeg" alt="workimage"className="w-20 h-20 p-2 inline-block border border-black/10 rounded-lg bg-white"/>
            <div className="pl-4">
            ...
            <figure className="flex pb-12">
            <img src="./images/coffee.jpeg" alt="workimage" className="w-20 h-20 p-2 inline-block border border-black/10 rounded-lg bg-white"/>
            <div className="pl-4">
