          ...
          {visualData.map((item, index) => {
            return (
              <div className="rounded relative group">
                <img src={item.img} />
                <div className="absolute top-0 left-0 w-full h-full opacity-0 group-hover:bg-black/80 group-hover:opacity-100 transition duration-300 ease-in-out">
                  <div className="absolute z-10 rounded top-1/2 left-1/2 bg-white -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100">
                    <div className="p-7">
                      ...
                      <p className="text-xl leading-[34px]">{item.desc}<br />
                        <a href={item.link} className="block mt-5 border rounded-sm py-2.5 text-center mb-5 leading-[22px]">View More</a>
                      </p>
                    </div>
                  </div>
                </div>
