...
const projects = [
  {
    ...
    conceptTitle: "設計理念",
    conceptDescription: "設計理念是融合了自然和美學的元素。靈感來自於大自然的美妙，融合了自然元素和動物元素，創造出一個獨特而令人難忘的視覺效果。",
    researchTitle: "設計研究",
    researchImgs: [
  ...
  },
  {
    ...
    conceptTitle: "設計理念",
    conceptDescription: "呈現自然、和諧和歡樂的感覺。讓人們感受到生命力和活力。這也代表著一種生活態度，即積極向上、樂觀進取、享受生活。",
    researchTitle: "設計研究",
    researchImgs: [
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
  ...
  },
  {
    ...
    conceptTitle: "設計理念",
    conceptDescription: "想要傳達夏日的愉悅的氛圍，在這個季節里充滿能量，享受一整個夏天的清爽美好體驗。",
    researchTitle: "設計研究",
    researchImgs: [
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
  ...
  },
  {
    ...
    conceptTitle: "設計理念",
    conceptDescription: "通過美好的夏日場景，營造出一種令人愉悅的品酒體驗，與讀者可以在情感上產生共鳴，勾起對於商品產生好奇和興趣；進而提高對商品的印象和好感。 ",
    researchTitle: "設計研究",
    researchImgs: [
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
  ...
  },
  {
    ...
    conceptTitle: "設計理念",
    conceptDescription: "傳達一種奢華和高貴的氛圍，讓人瞬間享受到經典、高級、輝煌、閃耀的精神享受。",
    researchTitle: "設計研究",
    researchImgs: [
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
  ...
  },
  {
    ...
    conceptTitle: "設計理念",
    conceptDescription: "幾米的插畫風格和酒款形成獨特的融合，藝術和浪漫所帶來溫暖的氛圍。同時也代表著一種溫暖的陪伴擁抱自己。",
    researchTitle: "設計研究",
    researchImgs: [
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
      "https://cdn.dribbble.com/users/64052/screenshots/3316798/media/c28e236e510bb25a31f468f1ec05048c.png?resize=320x240&vertical=center",
...
export const VisualDetail = () => {
  ...
  const { img, title, summary, backgroundTitle, backgroundDescription, conceptTitle, conceptDescription, researchTitle, researchImgs } = projects[params.vid - 1];
  return (
    <div>
      <div className="container">
        ...
        <h3 className="font-bold text-3xl leading-10 pt-8 pb-6 py-0 text-black">{conceptTitle}</h3>
        <p className="text-xl leading-7 pb-20 text-gray">{conceptDescription}</p>
        <h3 className="font-bold text-3xl pb-7">{researchTitle}</h3>
        <div className="grid grid-cols-4 gap-4">
          {researchImgs.map((img, index) => (
